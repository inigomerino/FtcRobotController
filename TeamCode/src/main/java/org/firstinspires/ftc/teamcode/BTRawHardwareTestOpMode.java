    ...
    private void runOdometer(String name, long seconds) {
        ...
        try {
            ...
            while (opModeIsActive() && ( System.currentTimeMillis() - startTime < maxTime )) {
                ...
                revolutions = m.getCurrentPosition();   // NOTE: TODO: WATCH FOR INT OVERFLOWs. This has info BUT appears to be outdated: https://docs.ftclib.org/ftclib/features/hardware/motors
                this.updateReading("Odometer '" + name + "' ticks: " + revolutions);
            }
