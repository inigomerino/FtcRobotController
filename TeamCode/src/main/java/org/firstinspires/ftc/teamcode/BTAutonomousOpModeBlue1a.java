...
@Autonomous()
public class BTAutonomousOpModeBlue1a extends BTAutonomousOpModeV2 {
    ...
    protected BTIRobot makeRobot(BTVisionProcessor.Selected pixLoc)
        ...
        BTLocation blue1PixelCenterPos  = new BTLocation(58.0, 39.0, pixOrient); //90.0);
        BTLocation blue1CornerPos       = new BTLocation( 8.0,  8.0, 90.0);
