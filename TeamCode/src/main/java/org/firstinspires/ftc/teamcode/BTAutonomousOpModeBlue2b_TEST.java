...
@Autonomous()
public class BTAutonomousOpModeBlue2b_TEST extends BTAutonomousOpModeV2 {
    ...
    protected BTIRobot makeRobot(BTVisionProcessor.Selected pixLoc)
        ...
        BTLocation blue2PixelCenterPos1  = new BTLocation(106.0, 39.0, 90.0);
        BTLocation blue2PixelCenterPos2  = new BTLocation(106.0, 39.0, pixOrient);
        BTLocation blue2PixelCenterPos3  = new BTLocation(106.0, 39.0, 90.0);
        ...
        r.addStop(blue2PixelCenterPos1);     // drive to push pixel
        r.addStop(blue2PixelCenterPos2);     // drive to push pixel
        r.addStop(blue2PixelCenterPos3);     // drive to push pixel
